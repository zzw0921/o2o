...
function getLangDate(){
    ...
    document.getElementById("nowTime").innerHTML = "亲爱的<span style='color: red;font-weight: bold'>[[${session.user.userName}]]</span>，"+timeValue+"好！ 欢迎使用layuiCMS 2.0模版。当前时间为： "+newDate+"　"+week;
